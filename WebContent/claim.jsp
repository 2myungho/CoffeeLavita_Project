							...
							<div class="claim-left-secondbox">
								<table cellspacing="0">
									...
									<tr>
										...
										<td>
											<input class="claim-title" type="text" size="20" maxlength="20" placeholder="제목을 입력하세요.">
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<textarea name="consultation" id="consultation" rows="5" cols="45">내용을 입력하세요.</textarea>
										</td>
									</tr>
